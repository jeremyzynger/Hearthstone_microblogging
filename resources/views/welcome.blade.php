    ...
    <div class="relative flex items-top justify-center min-h-screen bg-white sm:items-center py-4 sm:pt-0">
        ...
        <div class="mx-auto sm:px-6 lg:px-2">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <div>
                    <img src="meerkat.gif">
                    <span class="text-9xl bg-blue-700  text-gray-500 font-amatic font-black">Hearth</span>
                    <span class="text-9xl bg-yellow text-gray-500 font-amatic font-black">Stone</span>
